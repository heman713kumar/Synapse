...
import { WifiOffIcon, XIcon, StarIcon, MoreVerticalIcon, FlagIcon, ShieldCheckIcon, UserPlusIcon, BarChartIcon,
    AlertTriangleIcon,
    ArrowUpIcon,
    ArrowDownIcon,
    RocketIcon,
...
export const IdeaDetail: React.FC<IdeaDetailProps> = ({ ideaId, currentUser, isGuest, setPage, onAchievementsUnlock, onGuestAction }) => {
  ...
  async (isInitialLoad: boolean) => {
    ...
    if (!currentUser) {
      setBackendOnline(false);
      setError("Please log in to view this idea");
      setIsLoading(false);
      return;
    }
  ...
  [ideaId, currentUser] // ✅ ADD currentUser
);
